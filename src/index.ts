...
import { J2GConfigOptions, J2GCreateOptions } from "./types/j2g-config-options.type";
...
program.command('create', { isDefault: true })
    ...
    .option('-s, --source <source-branch>', 'Also create a git branch from source-branch')
    .option('-c, --copy', 'Copy branch name to clipboard')
    .action((code: string, options: J2GCreateOptions) => branchCommand(code, options));
